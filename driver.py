...
while 1:
    ...
    head_rotate_left = head_cascade.detectMultiScale(gray_rotate_left, 1.3, 5)
    head_rotate_right = head_cascade.detectMultiScale(gray_rotate_right, 1.3, 5)

    for (ex,ey,ew,eh) in head:
        cv2.rectangle(frame, (ex, ey), (ex + ew, ey + eh), (0, 255, 0), 2)
    
    for (ex,ey,ew,eh) in head_rotate_left:
        cv2.rectangle(rotate_frame_left, (ex, ey), (ex + ew, ey + eh), (0, 255, 0), 2)
    
    for (ex,ey,ew,eh) in head_rotate_right:
